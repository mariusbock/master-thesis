...
class LRScheduler(object):
    ...
    base_lr : float
        Base learning rate, iterations.e. the starting learning rate.
    train_epochs : int
        Number of training train_epochs.
    step : list
        A list of train_epochs to decay the learning rate.
    decay_factor : float
    ...
    warmup_epochs : int
        Number of train_epochs for the warmup stage.
    warmup_lr : float
