...
from networks.person.resnet_v2_sn import *
from networks.person.devkit.ops import L2Norm
from networks.person.devkit.ops import SwitchNorm2d
...
class ACSPNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # commented out detection head part to only obtain feature map after feature extraction layer
